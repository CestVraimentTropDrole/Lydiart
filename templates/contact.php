...
<div class="w-full h-fit">
    <div class="relative">
        ...
        <div class="w-full z-50 flex flex-col items-center py-20 px-56 gap-8 bg-[rgba(0,0,0,0.6)] relative">
            <h4 class="font-playfair text-blanc_full"><?php echo($title); ?></h4>
            <p class="font-poppins text-blanc_full text-center"><?php echo($description); ?></p>
